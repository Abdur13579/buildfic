...
<?php 
	...
	if (isset($_POST["judul"]))
	{
		...
		$judul = $_POST['judul'];
		$tulisan = $_POST['tulisan_dibawah'];
		$perintah_mysql = "UPDATE `top_b` SET `judul`='$judul',`tulisan_dibawah`='$tulisan' WHERE id=1";
		$sql = mysqli_query($connection,$perintah_mysql)or die("edit error");		
		
		if($_FILES['fileField']['tmp_name'] != ""){
		move_uploaded_file( $_FILES['fileField']['tmp_name'], "../upload/top_b_icon_bisa_diupdate.png");
		}
...
<?php 
	// untuk mengambil data untuk ditampilkan
  {
	  include "../connection.php";
                            ...
                            <div class="review-tab-pro-inner">
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    <div class="product-tab-list tab-pane fade active in" id="description">
										<form enctype="multipart/form-data" action="product-edit_top_b.php" method="post" enctype="multipart/form-data">
											<div class="row" action="product-edit_top_b.php" >
												<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
													<div class="review-content-section">
														<div class="input-group mg-b-pro-edt">
															<span class="input-group-addon"><i class="icon nalika-user" aria-hidden="true"></i></span>
															<input type="text" class="form-control" placeholder="Judul" name="judul" value="<?php echo $top_b_judul; ?>" >
														</div>
														<div class="input-group mg-b-pro-edt">
															<span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
															<input type="text" class="form-control" placeholder="Tulisan" name="tulisan_dibawah" value="<?php echo $top_b_tulisan_dibawah; ?>">
														</div>
														<div class="input-group mg-b-pro-edt">
