...
<?php 
	...
	if (isset($_POST["tulisan"]))
	{
	
		$tulisan = $_POST['tulisan'];    
		$sql = mysqli_query($connection,"UPDATE `top_c` SET `tulisan`='$tulisan' WHERE id=1")or die("edit error");		
		
		if($_FILES['fileField']['tmp_name'] != ""){
		move_uploaded_file( $_FILES['fileField']['tmp_name'], "../upload/top_c_background_path_bisa_diupdate.jpg");
		}
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">
									<form class="login-form" action="product-edit_top_c.php" method="post" enctype="multipart/form-data">
												...
												<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
													<div class="review-content-section">
														<div class="input-group mg-b-pro-edt">
															...
															<input type="text" class="form-control" placeholder="Judul" name="tulisan" value="<?php echo  $top_c_tulisan; ?>">
														</div>
														<div class="input-group mg-b-pro-edt">
															<span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
															<input type="file" class="form-control" placeholder="top_c_background_path_bisa_diupdate.jpg" name="fileField">
														</div>
													</div>
												</div>
												<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
